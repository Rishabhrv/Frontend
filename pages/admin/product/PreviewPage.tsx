...
import {
  ChevronLeft, ChevronRight, Menu, Plus, Minus,
  Search, Bookmark, TextInitial, Type,
} from "lucide-react";
        ...
        {sidebarOpen && (
          <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
            <div className="px-4 py-4 border-b border-white/5 flex-shrink-0 flex items-center justify-between">
              ...
              <span className="text-[9px] font-semibold text-amber-400/70 uppercase tracking-wider border border-amber-400/20 rounded px-1.5 py-0.5">
                Preview
              </span>
            </div>
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              {panel === "toc" && (
                <div className="py-2">
                  ...
                  >
                    <span className="text-xs font-semibold text-gray-200 group-hover:text-white leading-tight line-clamp-2 text-left">{title}</span>
